...
// enum IZIFileType { IMAGE, FILE, AVATAR, ICON, IMAGES }
...
//   // static Future<File> _resizeImage(String filePath,
//   //     {int? height = 1024, int? width = 1024, int? quality = 100}) async {
...
//   //     return imageWidget();
//   //   } else if (type == IZIFileType.IMAGES) {
//   //     return newImages();
//   //   }
//   //   return iconWidget();
//   // }
...
//         ),
//         height: IZIValidate.nullOrEmpty(widget.height)
//             ? IZIDimensions.ONE_UNIT_SIZE * 70
//             : widget.height!,
//         width: IZIValidate.nullOrEmpty(widget.width)
//             ? double.infinity
//             : widget.width!,
...
//           ),
//       height: IZIValidate.nullOrEmpty(widget.height)
//           ? IZIDimensions.ONE_UNIT_SIZE * 250
//           : widget.height!,
//       width: IZIValidate.nullOrEmpty(widget.width)
//           ? IZIDimensions.ONE_UNIT_SIZE * 250
//           : widget.width!,
...
//                   Icons.add,
//                   color: ColorResources.CIRCLE_COLOR_BG3,
//                   size: !IZIValidate.nullOrEmpty(widget.height)
//                       ? widget.height! / 6
...
//   //         IZISize.device == IZIDevice.TABLE
//   //             ? IZIDimensions.ONE_UNIT_SIZE * 18
//   //             : IZIDimensions.ONE_UNIT_SIZE * 5,
//   //       ),
//   //       child: Icon(
//   //         Icons.camera_alt,
//   //         size: IZISize.device == IZIDevice.TABLE
//   //             ? IZIDimensions.ONE_UNIT_SIZE * 40
//   //             : IZIDimensions.ONE_UNIT_SIZE * 28,
//   //       ),
//   //     ),
//   //   );
//   // }
