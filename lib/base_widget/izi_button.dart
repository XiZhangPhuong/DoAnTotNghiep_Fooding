        ...
        child: Row(
          ...
          children: [
            if (!IZIValidate.nullOrEmpty(imageUrlIcon))
              SizedBox(
                height: sizeIcon ?? IZIDimensions.ONE_UNIT_SIZE * 30,
                width: sizeIcon ?? IZIDimensions.ONE_UNIT_SIZE * 30,
                child: IZIImage(
            ...
            if (icon != null)
              Icon(
                ...
                size: sizeIcon ?? IZIDimensions.FONT_SIZE_H5 * 1.25,
              )
            else
              const SizedBox(),
            SizedBox(
            ...
            if (label != null)
              Flexible(
                child: Text(
                  " $label",
                  style: TextStyle(
                    fontSize: fontSizedLabel ?? IZIDimensions.FONT_SIZE_H5,
