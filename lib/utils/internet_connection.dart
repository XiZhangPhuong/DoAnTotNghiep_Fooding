...
class InternetConnection {
  ...
  Future<void> _initState() async {
    _connecteStatus.value =
        await InternetConnectionChecker().hasConnection ? CONNECTION_STATUS.CONNECTED : CONNECTION_STATUS.DISCONNECTED;
  }

  CONNECTION_STATUS get getConnnectionStatus => _connecteStatus.value;
