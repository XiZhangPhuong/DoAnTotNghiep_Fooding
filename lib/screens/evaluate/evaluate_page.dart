              ...
              : SingleChildScrollView(
                child: Column(
                    children: [
                      ...
                      _viewShipperAndProducts(controller),
                      SizedBox(
...
/// shipper
///
Widget _viewShipperAndProducts(EvaluateController controller) {
  return Container(
    ...
    child: Row(
      children: [
        ClipRRect(
          ...
          child: IZIImage(
            controller.type == 'PRODUCT' ? controller.products.image!.first :          
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                controller.type == 'PRODUCT' ? controller.products.name! : 
              ...
              Text(
                controller.type == 'PRODUCT' ? 'x${controller.products.quantity!}' : 
              ...
              Text(
                controller.checkPrice(controller.type),
                style: TextStyle(
                  color: ColorResources.GREY,
                  fontFamily: NUNITO,
                  fontWeight: FontWeight.w400,
