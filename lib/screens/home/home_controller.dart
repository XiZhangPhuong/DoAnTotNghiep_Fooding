...
class HomeController extends GetxController {
  ...
  void gotoDetailFood(String id) {
    ...
    // });
    Get.find<DashBoardController>().curenIndex.value = 2;
    update();
  }
    ...
    databaseFood.onValue.listen((event) {
      ...
      values.forEach((key, value) {
        Food food = Food(
            ...
            name_Food: values['name_Food'],
            category_Food: values['category_Food'],
            image_Food: values['image_Food'],
            information_Food: values['information_Food'],
            quantity: values['quantity'],
            price_Food: values['price_Food']);
        listFood.add(food);
      });
