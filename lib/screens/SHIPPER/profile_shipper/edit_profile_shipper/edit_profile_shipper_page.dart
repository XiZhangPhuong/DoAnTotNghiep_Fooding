...
class EditProfileShipper extends GetView {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder(
        init: EditProfileShipperController(),
        builder: (EditProfileShipperController controller) {
      ...
      bottomSheet: MediaQuery.of(context).viewInsets.bottom > 0
          ? const SizedBox()
          : GetBuilder(
              builder: (EditProfileShipperController controller) => Container(
                margin: EdgeInsets.only(
                  bottom: IZIDimensions.SPACE_SIZE_2X,
                ),
                width: IZIDimensions.iziSize.width,
