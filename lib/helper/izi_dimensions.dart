...
mixin IZIDimensions {
  ...
  static double FONT_SIZE_SPAN_SMALL_EXTRA = 15.0 * ONE_UNIT_SIZE; // 10 // Cho các trường hợp chữ nhỏ.
  static double FONT_SIZE_SPAN_SMALL = 22.0 * ONE_UNIT_SIZE; // 13 // Nội dung chi tiết.
  static double FONT_SIZE_SPAN = 24.0 * ONE_UNIT_SIZE; // 14 // Bình thường.
  static double FONT_SIZE_H6 = 26.0 * ONE_UNIT_SIZE; // 16 // Tiêu đề danh sách dịch vụ.
  static double FONT_SIZE_DEFAULT = 22.5 * ONE_UNIT_SIZE;
  static double FONT_SIZE_H5 = 28.0 * ONE_UNIT_SIZE; // 18 // Button lớn, splash, đăng ký, đăng nhập.
