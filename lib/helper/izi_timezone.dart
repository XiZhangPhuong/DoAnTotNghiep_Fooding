...
//     //
//     // Get timezone from shared preferences.
//     return time_zone.TZDateTime.fromMillisecondsSinceEpoch(time_zone.getLocation(sl<SharedPreferenceHelper>().getTimeZoneName), millisecondsSinceEpoch).toLocal();
//   }
...
//     final _dateTime = time_zone.TZDateTime.from(dateTime, time_zone.getLocation(sl<SharedPreferenceHelper>().getTimeZoneName));
